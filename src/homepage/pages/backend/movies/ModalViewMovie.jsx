    ...
    <ModalWrapper>
      <div className="modal-main bg-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[800px] w-full rounded-md overflow-hidden border border-line">
        <div className="modal-banner relative">
            ...
            <ul className="flex gap-2 items-center">
              <li>
                <button className="flex gap-2 bg-dark px-4 py-1.5 rounded-md text-light font-bold">
                  <Play fill="text-light" />
                  Play
                </button>
              </li>
              <li>
                <button className="size-[40px] grid place-content-center rounded-full border-[1px] border-dark bg-light bg-opacity-50">
                  <Plus />
                </button>
              </li>
              <li>
          ...
          <button
            className="absolute top-3 right-3 size-[35px] grid place-content-center text-dark bg-light rounded-full"
            onClick={() => handleClose()}
          >
            <X />
          </button>
        ...
        <div className="modal-body p-4 ">
          <div className="grid grid-cols-[1fr,_250px] gap-5">
            <div>
              <ul className="flex gap-3 items-center text-xs mb-3">
                <li className="border-[1px] border-dark p-[1px] py-1 px-2.5 text-[12px] leading-none">
                  <span className="translate-y-0 block">
                    {movieInfo.movie_rating}
                  </span>
                </li>
                <li>{movieInfo.movie_year}</li>
                <li>{movieInfo.movie_duration}</li>
                <li className="border-[1px] border-dark p-[1px] py-[0.5px] px-1.5 text-[9px]">
                  HD
                </li>
              </ul>
            ...
            <div className="space-y-3 ">
              <p className="text-xs leading-relaxed">
                <span className="opacity-60 text-xs">Cast:</span>
                ...
                <div className="p-4 bg-secondary">
                  <div className="flex justify-between items-center mb-5">
                    <ul className="flex gap-3 items-center text-xs">
                      <li className="border-[1px] border-dark p-[1px] py-1 px-2.5 text-[12px] leading-none">
                        <span className="translate-y-0 block">{item.movie_rating}</span>
                      </li>
                    ...
                    <button className="size-[50px] rounded-full border-[1px] border-dark grid place-content-center">
                      <Plus />
                    </button>
                  </div>
