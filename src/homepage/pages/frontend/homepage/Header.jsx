...
const Header = () => {
  ...
  return (
    <header className={`${scrollPosition > 200 ? "bg-black z-[9999999]" : ""} w-full bg-gradient-to-b from-black to-transparent py-5 px-10 fixed top-0 left-0 transition-all z-50`}>
